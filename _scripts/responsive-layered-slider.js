...
$(document).ready(function() {
    ...
    var controls_color = 'rgba(0,0,0,0.3)';
    var controls_hover_color = 'rgba(0,0,0,1)';
    var progress_size = '0';
    var current_slide = 1;
    var per_slide_duration = selected_element.attr('data-animation');
    var end_duration = 5000;
    ...
    function check_overlay() {
        ...
        if (current == 'true') {
            ...
            while (i < slider.find(".sim-slider-slide").length) {
                ...
                text += '<div class="sim-slider-current-inner-tab"  data-slide="' + i + '" style="width:10px;height:10px;float:left;margin:0 5px;' + background_color + '-moz-border-radius: 50% 50% 50% 50%;-webkit-border-radius: 50% 50% 50% 50%;border-radius: 50% 50% 50% 50%;"></div>';
            }
            slider.prepend('<div class="sim-slider-current" style="width:100%;height:10px;position:absolute;left:0px;bottom:20px;z-index:5;"><div class="sim-slider-current-inner" style="margin:0 auto;height:10px;width:' + ((slider.find(".sim-slider-slide").length) * 20) + 'px;">' + text + '</div></div>');
        }
        if (progress == 'true') {
    ...
    function check_layer(element, type) {
        ...
        if (effect == 'bounceIn') {
            fadeout_effect = 'bounceOut';
            fadein_effect = effect;
        }
        if (effect == 'fadeIn') {
            fadeout_effect = 'fadeOut';
            fadein_effect = effect;
        }
        if (effect == 'rollIn') {
            fadeout_effect = 'rollOut';
            fadein_effect = effect;
        }
        if (effect == 'fadeInDown') {
            fadeout_effect = 'fadeOutUp';
            fadein_effect = effect;
        }
        if (effect == 'fadeInDownBig') {
            fadeout_effect = 'fadeOutUpBig';
            fadein_effect = effect;
        }
        if (effect == 'fadeInUp') {
            fadeout_effect = 'fadeOutDown';
            fadein_effect = effect;
        }
        if (effect == 'fadeInUpBig') {
            fadeout_effect = 'fadeOutDownBig';
            fadein_effect = effect;
        }
        if (effect == 'fadeInLeft') {
            fadeout_effect = 'fadeOutLeft';
            fadein_effect = effect;
        }
        if (effect == 'fadeInLeftBig') {
            fadeout_effect = 'fadeOutLeftBig';
            fadein_effect = effect;
        }
        if (effect == 'fadeInRight') {
            fadeout_effect = 'fadeOutRight';
            fadein_effect = effect;
        }
        if (effect == 'fadeInRightBig') {
            fadeout_effect = 'fadeOutRightBig';
            fadein_effect = effect;
        }
        if (effect == 'flipInX') {
            fadeout_effect = 'flipOutX';
            fadein_effect = effect;
        }
        if (effect == 'flipInY') {
            fadeout_effect = 'flipOutY';
            fadein_effect = effect;
        }
        if (effect == 'zoomIn') {
            fadeout_effect = 'zoomOut';
            fadein_effect = effect;
        }
        if (effect == 'zoomInDown') {
            fadeout_effect = 'zoomOutDown';
            fadein_effect = effect;
        }
        if (effect == 'zoomInUp') {
            fadeout_effect = 'zoomOutUp';
            fadein_effect = effect;
        }
        if (effect == 'zoomInLeft') {
            fadeout_effect = 'zoomOutLeft';
            fadein_effect = effect;
        }
        if (effect == 'zoomInRight') {
            fadeout_effect = 'zoomOutRight';
            fadein_effect = effect;
        }
